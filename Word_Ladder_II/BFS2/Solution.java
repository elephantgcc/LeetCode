...
public class Solution {
	public ArrayList<ArrayList<String>> findLadders(String start, String end, HashSet<String> dict) {
		...
		HashMap<String, ArrayList<String>> prevMap = new HashMap<String, ArrayList<String>>();
	...
	private ArrayList<ArrayList<String>> buildPaths(HashMap<String, ArrayList<String>> prevMap, String end) {
		System.out.println(prevMap);
		ArrayList<ArrayList<String>> result = new ArrayList<ArrayList<String>>();
		if (!prevMap.containsKey(end)) {
			...
			ArrayList<String> prevWords = prevMap.get(end);
